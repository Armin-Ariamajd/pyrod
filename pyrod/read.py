...
def pml_feature(feature, pyrod_pharmacophore, logger):
    ...
    if pyrod_pharmacophore:
        try:
            ...
            update_user('You attempted to read a pml pharmacophore, that was not generated by PyRod or with an older '
                        'version of PyRod. Please set pyrod pharmacophore to false!', logger)
            sys.exit()
    feature_list[2] = 'M'
